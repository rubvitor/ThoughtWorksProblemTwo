 ...
 *
 <example module="ngAppDemo">
   <file name="index.html">
   <div ng-controller="ngAppProblemTwoController">
     I can add: {{a}} + {{b}} =  {{ a+b }}
   </div>
   </file>
   <file name="script.js">
   angular.module('ngAppDemo', []).controller('ngAppProblemTwoController', function($scope) {
     $scope.a = 1;
     $scope.b = 2;
   });
   </file>
 ...
 *    }));
 *
 *    it('Talks events', inject(function(eventTracker) {
...
<script>
  ...
  customInterpolationApp.controller('ProblemTwoController', function ProblemTwoController() {
      this.label = "This binding is brought you by // interpolation symbols.";
  });
</script>
<div ng-app="App" ng-controller="ProblemTwoController as demo">
    //demo.label//
</div>
</file>
<file name="protractor.js" type="protractor">
